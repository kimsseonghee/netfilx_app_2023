...
function Banner() {
    ...
    const fetchData =  async () => {
        ...
        //https://api.themoviedb.org/3/movie/{movie_id}/videos?api_key=<<api_key>>&language=en-US&append_to_response=videos
    ...
    return (
        ...
        style={{backgroundImage:`url("https://image.tmdb.org/t/p/original/${movie.backdrop_path}")`, backgroundPosition:"top center",
